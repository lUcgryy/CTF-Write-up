...
Đây là một thử thách CTF nhỏ dành cho các cộng tác viên (CTV) của FPT Information Assurance Club (FIA) liên quan đến các kiến thức cơ bản liên quan đến hệ điều hành Linux trên nền tảng Tryhackme. Link room: https://tryhackme.com/room
