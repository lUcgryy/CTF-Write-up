...
![Question](/FPTUHacking_CTF_2022/V%C3%B2ng%20lo%E1%BA%A1i/Cryptography/images/RRSSAA/Question.png)

File mã hóa: [enc.py](/FPTUHacking_CTF_2022/V%C3%B2ng%20lo%E1%BA%A1i/Cryptography/Src_code/RRSSAA/enc.py)

Output của file trên (message đã được mã hóa): [out.txt](/FPTUHacking_CTF_2022/V%C3%B2ng%20lo%E1%BA%A1i/Cryptography/Src_code/RRSSAA/output.txt)
...
![Part1](/FPTUHacking_CTF_2022/V%C3%B2ng%20lo%E1%BA%A1i/Cryptography/images/RRSSAA/Part1.png)
...
![Part2](/FPTUHacking_CTF_2022/V%C3%B2ng%20lo%E1%BA%A1i/Cryptography/images/RRSSAA/Part2.png)
...
![Question](/FPTUHacking_CTF_2022/V%C3%B2ng%20lo%E1%BA%A1i/Cryptography/images/characters/Question.png)

File mã hóa: [enc.py](/FPTUHacking_CTF_2022/V%C3%B2ng%20lo%E1%BA%A1i/Cryptography/Src_code/characters/enc.py)

Output của file trên (message đã được mã hóa): [out.txt](/FPTUHacking_CTF_2022/V%C3%B2ng%20lo%E1%BA%A1i/Cryptography/Src_code/characters/out.txt)
...
![factordb](/FPTUHacking_CTF_2022/V%C3%B2ng%20lo%E1%BA%A1i/Cryptography/images/characters//factordb.png)
...
print(flag)
```
Script đầy đủ: [dec.py](/FPTUHacking_CTF_2022/V%C3%B2ng%20lo%E1%BA%A1i/Cryptography/Script/characters.py)
...
![Question](/FPTUHacking_CTF_2022/V%C3%B2ng%20lo%E1%BA%A1i/Cryptography/images/keyRSA//Question.png)

File mã hóa: [enc.py](/FPTUHacking_CTF_2022/V%C3%B2ng%20lo%E1%BA%A1i/Cryptography/Src_code/keyRSA/enc.py)

Đầu tiên, ta hãy nhìn vào file [enc.py](/FPTUHacking_CTF_2022/V%C3%B2ng%20lo%E1%BA%A1i/Cryptography/Src_code/keyRSA/enc.py) thì ta thấy có tham số x khá là lạ
```python
x = p % (n//2)
```
...
Tiếp tục đọc [enc.py](/FPTUHacking_CTF_2022/V%C3%B2ng%20lo%E1%BA%A1i/Cryptography/Src_code/keyRSA/enc.py) thì mình thấy dòng này
```python
user_d = int(input("\nEnter your key : \n"))
    if user_d != d:
...
![Tính chất](/FPTUHacking_CTF_2022/V%C3%B2ng%20lo%E1%BA%A1i/Cryptography/images/keyRSA/Math.png)
...
Đây là script để giải thử thách này: [dec.py](/FPTUHacking_CTF_2022/V%C3%B2ng%20lo%E1%BA%A1i/Cryptography/Script/keyRSA.py)
